...
/** 播放器控制面板代理 */
@protocol TKPlayerControlDelegate <NSObject>
...
@interface TKPlayerControlView : UIView
...
/** 进度滑杆 */
@property (nonatomic, strong) TKVideoSlider *videoSlider;
/** 播放时间 */
...
/** 播放器控制面板代理 */
@property (nonatomic, weak) id<TKPlayerControlDelegate> delegate;
/** 隐藏控制面板延时时间 缺省5s */
