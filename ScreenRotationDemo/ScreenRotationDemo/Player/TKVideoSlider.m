...
#import "TKVideoSlider.h"

#define SLIDER_X_BOUND 30
#define SLIDER_Y_BOUND 40

@interface TKVideoSlider()

@property (nonatomic,assign) CGRect lastBounds;

@end

@implementation TKVideoSlider
...
- (void)setup {
    [self setThumbImage:[UIImage imageNamed:@"cc_slider"] forState:UIControlStateHighlighted];
    [self setThumbImage:[UIImage imageNamed:@"cc_slider"] forState:UIControlStateNormal];
}
