...
static const CGFloat PlaybackControlsAutoHideTimeInterval = 0.5f;
@interface TKPlayerControlView()
...
@implementation TKPlayerControlView
...
- (void)_showOrHideStatusBar
{
    switch (_statusBarHideState) {
        case TKStatusBarHideStateFollowControls:
        {
            [[UIApplication sharedApplication] setStatusBarHidden:!self.isShowing];
        }
            break;
        case TKStatusBarHideStateNever:
        {
            [[UIApplication sharedApplication] setStatusBarHidden:NO];
        }
            break;
        case TKStatusBarHideStateAlways:
        {
...
- (UIButton *)fullScreenButton
{
    if (!_fullScreenButton) {
        ...
        [_fullScreenButton setImage:[UIImage imageNamed:@"cc_fullscreen"] forState:UIControlStateNormal];
        [_fullScreenButton setImage:[UIImage imageNamed:@"cc_shrinkscreen"] forState:UIControlStateSelected];
...
- (UIButton *)retryButton
{
    if (!_retryButton) {
        ...
        [_retryButton setImage:[UIImage imageNamed:@"btn_video_restart"] forState:UIControlStateNormal];
...
/** 滑杆 */
- (TKVideoSlider *)videoSlider
{
    if (!_videoSlider) {
        _videoSlider = [[TKVideoSlider alloc]init];
