...
@interface TKScrollViewAndNavVC () <UITableViewDelegate, UITableViewDataSource>
@property (nonatomic, strong) TKTableView *tableView;
@end

@implementation TKScrollViewAndNavVC
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    TKScrollViewAndNavVC *vc = [TKScrollViewAndNavVC new];
