...
#define kiPhone11Pro ([UIScreen instancesRespondToSelector:@selector(currentMode)] ? CGSizeEqualToSize(CGSizeMake(1125, 2436), [[UIScreen mainScreen] currentMode].size) : NO)
#define kiPhone11ProMax ([UIScreen instancesRespondToSelector:@selector(currentMode)] ? CGSizeEqualToSize(CGSizeMake(1242, 2688), [[UIScreen mainScreen] currentMode].size) : NO)
//#define iPhone_Bang (KiPhoneX  || KiPhoneXR || KiPhoneXMax || kiPhone11Pro || kiPhone11ProMax)
#ifndef iPhone_Bang
#define iPhone_Bang (@available(iOS 11.0, *) && [UIApplication sharedApplication].keyWindow.safeAreaInsets.bottom > 0.0)
#endif
