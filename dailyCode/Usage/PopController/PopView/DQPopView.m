...
@interface DQPopView()<CAAnimationDelegate,UIGestureRecognizerDelegate>

@property (nonatomic ,weak) UIView *contentView;
@property (nonatomic ,weak) UIView *onView;
@property (nonatomic ,assign) DQPopViewDirection direct;
...
@implementation DQPopView

static  NSInteger const popViewTag              = 364;
+ (instancetype)getCurrentPopView{
    UIWindow *window = [UIApplication sharedApplication].keyWindow;
    DQPopView *oldPopView = (DQPopView *)[window viewWithTag:popViewTag];
    return oldPopView;
}
...
+ (instancetype)popUpContentView:(UIView *)contentView
    ...
    UIWindow *window = [UIApplication sharedApplication].keyWindow;
    DQPopView *oldPopView = [self getCurrentPopView];
    DQPopView *newPopView = [[DQPopView alloc] initWithFrame:window.bounds
                                                  direct:direct
                                                  onView:onView
    ...
    newPopView.showAnimation = [DQPopAnimationTool getShowPopAnimationWithType:direct contentView:contentView belowView:nil];
    newPopView.hidenAnimation = [DQPopAnimationTool getHidenPopAnimationWithType:direct contentView:contentView belowView:nil];
...
+ (instancetype)popSideContentView:(UIView *)contentView
    ...
    CABasicAnimation *showAnimation = [DQPopAnimationTool getShowPopAnimationWithType:direction contentView:contentView belowView:nil];
    CABasicAnimation *hidenAnimation = [DQPopAnimationTool getHidenPopAnimationWithType:direction contentView:contentView belowView:nil];
    
    DQPopView *popView =  [self popContentView:contentView showAnimation:showAnimation hidenAnimation:hidenAnimation];
...
+ (instancetype)popSideContentView:(UIView *)contentView
    ...
    DQPopViewDirection direction = DQPopViewDirection_SlideBelowView;
    CABasicAnimation *showAnimation = [DQPopAnimationTool getShowPopAnimationWithType:direction contentView:contentView belowView:belowView];
    CABasicAnimation *hidenAnimation = [DQPopAnimationTool getHidenPopAnimationWithType:direction contentView:contentView belowView:belowView];
    ...
    DQPopView *oldPopView = (DQPopView *)[belowView.superview viewWithTag:popViewTag];
    DQPopView *newPopView = [[DQPopView alloc] initWithFrame:frame
                                                  direct:direction
                                                  onView:nil
                                             contentView:contentView
                                                  offSet:0
...
+ (instancetype)popShowContentView:(UIView *)contentView
    ...
    CGRect frame = belowView.superview.bounds;
    frame.origin.y = CGRectGetMaxY(belowView.frame);
    frame.size.height -= CGRectGetHeight(belowView.frame);
...
+ (instancetype)popContentView:(UIView *)contentView
    ...
    DQPopView *oldPopView = (DQPopView *)[window viewWithTag:popViewTag];
    DQPopView *newPopView = [[DQPopView alloc] initWithFrame:window.bounds
                                                  direct:DQPopViewDirection_PopUpNone
                                                  onView:nil
                                             contentView:contentView
                                                  offSet:0
                                            triangleView:nil
...
- (void)animationPopContainerViewWithOldPopView:(DQPopView *)oldPopView{
    if (oldPopView) {
...
+ (void)hidenPopView{
    if (keyboardShow) {
        ...
        DQPopView *popView = (DQPopView *)[superView viewWithTag:popViewTag];
